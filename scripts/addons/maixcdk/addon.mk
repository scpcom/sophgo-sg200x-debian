...
$(BUILDDIR)/maixcdk-prepare-patch-stamp: $(BUILDDIR)/maixcdk-prepare-checkout-stamp
	...
	@sed -i 's|https://github.com/Tencent/rapidjson/archive|$(GIT_RELEASES_URL)/Tencent/rapidjson/archive|g' $(MAIXCDK_BUILD_DIR)/components/3rd_party/opencv/component.py
